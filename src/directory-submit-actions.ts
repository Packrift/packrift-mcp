...
const ACTIONS = [
  ...
  },
  {
    id: "mcp_blue",
    label: "MCP Blue",
    action_status: "manual_pr_ready",
    directory_status: "unlisted",
    priority: "medium",
    method: "Registry pull request or submit flow.",
    evidence: "MCP Blue accepts new servers through its public submit path and registry process; Packrift is not yet visible.",
    stale_markers: ["Packrift not visible in MCP Blue"],
    recrawl_subject: "Submit Packrift MCP to MCP Blue",
    next_action: "Open the MCP Blue submit process, add Packrift with the hosted endpoint and current manifest, then monitor for crawler/index publication.",
  ...
  },
  {
    ...
    priority: "medium",
    method: "Manual submit form.",
    evidence: "FindMCP has a public submit page for MCP servers; Packrift is not yet visible in public discovery.",
    stale_markers: ["Packrift not visible in FindMCP"],
    recrawl_subject: "Submit Packrift MCP to FindMCP",
    next_action: "Submit the hosted endpoint, source-specific start page, marketplace manifest, and exact-spec packaging procurement description.",
  ...
  },
  {
    ...
    evidence: "MCPLane is a broad MCP server discovery surface; Packrift is not yet visible by name.",
    stale_markers: ["Packrift not visible in MCPLane"],
    recrawl_subject: "Submit Packrift MCP to MCPLane",
    next_action: "Use the Publish Server flow with the hosted endpoint, source-specific update card, and first-useful-run activation proof.",
  ...
  },
  {
    ...
    priority: "medium",
    method: "Manual submit form.",
    evidence: "MCP Solutions has a public submit page; Packrift is not yet listed.",
    stale_markers: ["Packrift not visible in MCP Solutions"],
    recrawl_subject: "Submit Packrift MCP to MCP Solutions",
    next_action: "Submit Packrift with the hosted endpoint, no-auth policy, and source-specific first-run proof; decide separately whether any paid placement is worth it.",
...
export function mcpDirectorySubmitActionsPayload(runtime: DirectorySubmitActionsRuntime) {
  ...
  return {
    release: "PACKRIFT-MCP-DIRECTORY-SUBMIT-ACTIONS-R30",
