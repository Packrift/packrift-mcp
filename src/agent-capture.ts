...
export function allAgentCaptureMarkdown(runtime: AgentCaptureRuntime): string {
  ...
  return [
    ...
    "## What This Is",
    "",
    "One current Packrift map for every agent surface we care about: MCP clients, ChatGPT/OpenAI commerce, Shopify UCP, Claude, Cursor, Windsurf, Codex, Glama, registries, crawlable corpora, search crawlers, the browser-agent bridge, and Browserbase Browse as a candidate browser-skill lane.",
    "",
    "## Operating Rules",
    "",
    rules,
