...
const RESOURCE_DESCRIPTIONS: Record<string, string> = {
  ...
  "/ai/conversion-route-catalog.json": "Machine-readable conversion route catalog for all verified purchase-ready SKUs with product, reorder, quote, SKU markdown, SKU JSON, and copy-procurement-spec handoffs.",
  ...
  "/ai/measured-handoffs.json": "Compact MCP-controlled measured handoff directory for priority exact-spec SKUs with product, reorder, quote, SKU markdown, SKU JSON, and copy-procurement-spec routes.",
  "/ai/measured-handoffs.md": "Crawler-readable measured handoff directory for priority exact-spec SKU product, reorder, quote, and no-match recovery routes.",
  "/ai/measured-handoffs.csv": "Spreadsheet-friendly measured handoff directory for priority exact-spec SKU routes.",
