...
export const MCP_FIRST_RUN_ACTION_RELEASE = "PACKRIFT-MCP-FIRST-RUN-ACTION-R07";
export const MCP_FIRST_RUN_ACTIONS_RELEASE = "PACKRIFT-MCP-FIRST-RUN-ACTIONS-R06";
...
export function mcpFirstRunActionsPayload(runtime: FirstRunActionRuntime, source = "generic") {
  ...
  return {
    ...
    recommended_targets: ["generic_streamable_http", "stdio_mcp_remote", "claude_code", "codex", "cursor_windsurf_vscode", "cline"],
