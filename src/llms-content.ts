...
- [MCP buyer order handoffs](https://mcp.packrift.com/ai/mcp-buyer-order-handoffs.json): thin buyer/reviewer hub for mature source-preserving order handoffs; it links existing MCP /r/order and /r/cart routes and does not place orders
...
- [OpenAI preferred direct product feed TSV](https://mcp.packrift.com/ai/packrift-openai-products-preferred-direct-current.tsv): current 4,837-row validated direct handoff with 0 simulated rejects or warnings
- [OpenAI preferred direct product feed GZIP](https://mcp.packrift.com/ai/packrift-openai-products-preferred-direct-current.tsv.gz): compressed 4,837-row direct handoff for approved file-upload, SFTP, or API ingestion
