...
- [MCP buyer use cases](https://mcp.packrift.com/ai/mcp-buyer-use-cases.json): buyer-facing exact SKU reorder, fit-by-dimensions, mailer, label, no-match, and procurement-line workflows for qualified AI-commerce demand
