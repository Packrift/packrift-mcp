...
- [MCP external activation brief](https://mcp.packrift.com/ai/mcp-external-activation-brief.json): compact real-host run brief with the selected source-aware tasks needed to move external MCP tool calls toward the material usage gate
