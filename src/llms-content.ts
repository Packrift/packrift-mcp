...
- [MCP buyer order handoffs](https://mcp.packrift.com/ai/mcp-buyer-order-handoffs.json): thin buyer/reviewer hub for mature source-preserving order handoffs; it links existing MCP /r/order and /r/cart routes and does not place orders. Flat checkout task export: [JSONL](https://mcp.packrift.com/ai/mcp-buyer-order-handoffs-tasks.jsonl)
