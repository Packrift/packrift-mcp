...
async function liveMcpCheck() {
  ...
  return check(
    ...
    health?.version === EXPECTED_VERSION &&
      ...
      trackedFirstRunExecute?.release === "PACKRIFT-MCP-FIRST-RUN-ACTION-R07" &&
      ...
      firstRunActions?.release === "PACKRIFT-MCP-FIRST-RUN-ACTIONS-R06" &&
      ...
      firstRunActions?.first_run?.release === "PACKRIFT-MCP-FIRST-RUN-ACTION-R07" &&
      ...
      funnelSnapshot?.agent_adoption_progress?.release === "PACKRIFT-MCP-AGENT-ADOPTION-PROGRESS-R01" &&
      ...
      sourceActivationQueue?.agent_adoption_progress?.release === "PACKRIFT-MCP-AGENT-ADOPTION-PROGRESS-R01" &&
      ...
      directoryRefresh?.release === "PACKRIFT-MCP-DIRECTORY-REFRESH-R27" &&
      ...
      directorySubmitActions?.release === "PACKRIFT-MCP-DIRECTORY-SUBMIT-ACTIONS-R38" &&
      ...
      directoryUpdateCline?.release === "PACKRIFT-MCP-DIRECTORY-UPDATE-CARD-R10" &&
      ...
      reviewerActivation?.release === "PACKRIFT-MCP-REVIEWER-ACTIVATION-R10" &&
      ...
      trackedReviewerActivationGeneric?.release === "PACKRIFT-MCP-REVIEWER-ACTIVATION-R10" &&
      ...
      trackedReviewerActivationCline?.release === "PACKRIFT-MCP-REVIEWER-ACTIVATION-R10" &&
      ...
      agentCaptureOutreach?.release === "PACKRIFT-AGENT-CAPTURE-OUTREACH-R20" &&
      ...
      agentCaptureOutreach?.directory_submit_actions?.release === "PACKRIFT-MCP-DIRECTORY-SUBMIT-ACTIONS-R38" &&
