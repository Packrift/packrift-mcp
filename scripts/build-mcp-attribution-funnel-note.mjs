...
function markdown(snapshot, paths) {
  ...
  return [
    ...
    "",
    "- Add a stable MCP handoff identifier and tool name to create_cart_url events and cart URLs so first-party tool calls can be joined to GA4 cart and order events.",
